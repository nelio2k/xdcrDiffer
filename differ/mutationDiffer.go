...
func (dw *DifferWorker) diff() {
	...
	srcUUID, err := hlv.UUIDstoDocumentSource(dw.differ.sourceBucketUUID, dw.differ.sourceClusterUUID)
	if err != nil {
	...
	tgtUUID, err1 := hlv.UUIDstoDocumentSource(dw.differ.targetBucketUUID, dw.differ.targetClusterUUID)
	if err1 != nil {
		// This error is very unusual, therefore panic
